    ...
    {
        {
            if(rebuild_font)
            {
                ...
                else
                {
                    ...
                    uint32_t font_mode = ImGuiFreeType::LCD;
        ...
        ImGui::TextColored(ImVec4(0,0,0,1), "Hello font 1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ");
        ImGui::TextColored(ImVec4(0,0,0,1), "The quick brown fox jumps over the lazy dog ({}).!<>/|\\");

        ImGui::TextColored(ImVec4(1,1,1,1), "Hello font 1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ");
        ...
        std::cout << "rclock " << clk.getElapsedTime().asMicroseconds() / 1000. << std::endl;
